...
commands = {'/help': (list_commands, '', "Shows this message"),
            ...
            '/kick': (kick_user, "<channel> <nickname> <message>", 'Kick user (Admin/operator)'),
            '/list': (list_users, "<channel>", 'List members in channel'),
            '/channels': (list_channels, '', "List all channels"),
            '/w': (whisper_user, "<#channel> or <nickname> <message>", 'Send message to user och channel'),
            '/nick': (change_nick, "<nickname>", 'Change nickname. Must be unique'),
            ...
            '/joined': (display_user_channels, '', "List joined channels")}
